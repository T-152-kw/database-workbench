...
// Close Icon (X)
export const CloseIcon: React.FC<IconProps> = ({ size = 14, color = '#666' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Table Icon (for result tabs)
export const TableIcon: React.FC<IconProps> = ({ size = 14, color = '#555' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Update Icon (for update result tabs)
export const UpdateIcon: React.FC<IconProps> = ({ size = 14, color = '#555' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Error Icon (for error result tabs)
export const ErrorIcon: React.FC<IconProps> = ({ size = 14, color = '#dc3545' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
